    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start">
        ...
        <div className="text-center sm:text-left">
          <p className="font-semibold text-accent-600">{a.hakkimdaAltBaslik}</p>
          <h1 className="mt-1 text-3xl font-bold text-brand-800">Hakkımda</h1>
      ...
      {a.hakkimdaKartlar.length > 0 && (
        <div className="mt-8 grid grid-cols-3 gap-4">
          {a.hakkimdaKartlar.map((s, i) => (
            <div
              key={i}
      ...
      <div className="mt-10 rounded-2xl bg-brand-800 p-6 text-center sm:p-8">
        ...
        <a
          href={whatsappLink("Merhaba, sizinle görüşmek istiyorum.", a.whatsapp)}
          target="_blank"
